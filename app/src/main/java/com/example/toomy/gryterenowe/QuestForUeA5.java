 ...
 */
public class QuestForUeA5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_quest_for_ue_a5, container, false);
        Button QuestForUeBtn = (Button) v.findViewById(R.id.daleja6);
        setTimer(v);
        QuestForUeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                QuestForUeA6 questForUe = new QuestForUeA6();
