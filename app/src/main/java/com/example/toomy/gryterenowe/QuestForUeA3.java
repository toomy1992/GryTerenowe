 ...
 */
public class QuestForUeA3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_quest_for_ue_a3, container, false);
        QuestForUeBtn = (Button) v.findViewById(R.id.daleja4);
        ...
        QuestForUeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                QuestForUeA4 questForUe = new QuestForUeA4();
    ...
    public void enableSubmitIfReady(EditText answer, Button next) {
        ...
        if (answer.getText().toString().equals("Józef Lisak")){
