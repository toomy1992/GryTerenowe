 ...
 */
public class QuestForUeE2 extends Fragment {
    EditText answer;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_quest_for_ue_e2, container, false);
        QuestForUeBtn = (Button) v.findViewById(R.id.dalejkoniec);
        ...
        QuestForUeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                QuestForUeKoniec questForUe = new QuestForUeKoniec();
    ...
    private void enableSubmitIfReady(EditText answer, Button next) {
        ...
        if (answer.getText().toString().equals("Robert Tomanek")){
